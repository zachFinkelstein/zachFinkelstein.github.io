...
function RadarChartNoLegend(id, data, options) {
    require(["https://cdnjs.cloudflare.com/ajax/libs/d3/3.5.6/d3.min.js"], function () {
        var cfg = {
        ...
        axisGrid.selectAll(".axisLabel")
            ...
            .attr("fill", "#737373")
            .text(function (d, i) {
                return Format(maxValue * d / cfg.levels) + " lbs";
            });
